...
public class UserInfo {
    ...
    private String email;//varchar(50) PK
    ...
    private String hometown;//varchar(50)
    private int hometown_hidden;

    private String organization;//varchar(50)
    private int organization_hidden;

    private String signature;//varchar(200)

    public UserInfo() {
    }

    public UserInfo(InfoMessage info) {
